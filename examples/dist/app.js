              ...
              _vm._l(_vm.elementChild, function(opt) {
                return [
                  opt.tagName === "optgroup"
                    ? _c(
                        "optgroup",
                        { attrs: { value: opt.id, label: opt.text } },
                        _vm._l(opt.options, function(subopt) {
                          return _c(
                            "option",
                            { key: subopt.id, domProps: { value: subopt.id } },
                            [
                              _vm._v(
                                "\n                    " +
                                  _vm._s(subopt.text) +
                    ...
                    : _c("option", { key: opt.id, domProps: { value: opt.id } }, [
                        _vm._v(
                          "\n                " +
                            _vm._s(opt.text) +
                            "\n            "
  ...
  ********************************************** */
  ...
  __vue_render__$2._withStripped = true;
    ...
    const __vue_inject_styles__$2 = function (inject) {
      if (!inject) return
      inject("data-v-63a0d492_0", { source: "\n.has-error {\n    border-color: red;\n    border-width: 2px;\n    box-shadow: inset 0 0 15px red;\n}\n.error-message {\n    height: 1.2em;\n    color: #FF6666;\n}\n.half {\n    display: grid;\n    grid-template: max-content / 1fr 1fr;\n    grid-column-gap: 15px;\n}\n.prism-editor__textarea,\n.html-draft {\n    width: 450px;\n    height: 300px;\n    min-height: 100px;\n    min-width: 100px;\n}\n.my-editor {\n  background: #2d2d2d;\n  color: #ccc;\n\n  font-family: Fira code, Fira Mono, Consolas, Menlo, Courier, monospace;\n  font-size: 14px;\n  line-height: 1.5;\n  padding: 5px;\n}\n.prism-editor__textarea:focus {\n  outline: none;\n}\n", map: {"version":3,"sources":["/benoit/programmation/javascript/selectic-demo/examples/components/SelecticDraft.vue"],"names":[],"mappings":";AAmVA;IACA,iBAAA;IACA,iBAAA;IACA,8BAAA;AACA;AACA;IACA,aAAA;IACA,cAAA;AACA;AACA;IACA,aAAA;IACA,oCAAA;IACA,qBAAA;AACA;AAEA;;IAEA,YAAA;IACA,aAAA;IACA,iBAAA;IACA,gBAAA;AACA;AACA;EACA,mBAAA;EACA,WAAA;;EAEA,sEAAA;EACA,eAAA;EACA,gBAAA;EACA,YAAA;AACA;AACA;EACA,aAAA;AACA","file":"SelecticDraft.vue","sourcesContent":["\n<template>\n<div class=\"half\">\n    <fieldset>\n        <legend>\n            Vue component\n        </legend>\n        <prism-editor\n            :class=\"{\n                'html-draft': true,\n                'has-error': !isHTMLValid,\n                'my-editor': true,\n            }\"\n            v-model=\"html\"\n            :highlight=\"highlighter\"\n            language=\"vue\"\n            line-numbers\n        />\n        <div class=\"error-message\">\n            {{reason}}\n        </div>\n        <div>\n            <button\n                @click=\"redraw\"\n            >\n                Redraw component\n            </button>\n        </div>\n    </fieldset>\n    <fieldset>\n        <legend>\n            Example result\n        </legend>\n\n        <div>\n            <Selectic\n                :params=\"selecticParams\"\n                :child=\"selecticChild\"\n                @input=\"(value) => selecticValue = value\"\n                :key=\"`selectic-${drawId}`\"\n            />\n        </div>\n\n        <label>Selected value: <output>{{JSON.stringify(selecticValue)}}</output></label>\n    </fieldset>\n</div>\n</template>\n<script>\nimport Selectic from './WrapSelectic.vue';\n// import { PrismEditor } from 'vue-prism-editor';\n// import { highlight, languages } from \"prismjs/components/prism-core\";\n\nimport 'prismjs';\nimport 'prismjs/themes/prism.css';\nimport { PrismEditor } from \"vue-prism-editor\";\nimport \"vue-prism-editor/dist/prismeditor.min.css\"; // import the styles somewhere\n\n// import highlighting library (you can use any library you want just return html string)\n// import { highlight, languages } from \"prismjs/components/prism-core\";\nimport \"prismjs/components/prism-clike\";\nimport \"prismjs/components/prism-javascript\";\nimport \"prismjs/themes/prism-tomorrow.css\"; // import syntax highlighting styles\n\n\nfunction getJSON(str) {\n    return str.replace(/(?:([\"'])([^\\1\\n]+?)\\1|(\\w+))\\s*:/g, (str, _q, quotedAttr, attr) => {\n        const attribute = quotedAttr || attr;\n        return `\"${attribute}\":`;\n    }).replace(/'([^'\\n]*?)'/g, (str, quotedStr) => {\n        return `\"${quotedStr}\"`;\n    });\n}\n\nfunction extractCode() {\n    const search = document.location.search;\n    const [,rslt=''] = search.match(/[?&]code=((?:\\w|%)+)\\b/) || [];\n    return decodeURIComponent(rslt);\n}\n\nexport default {\n    name: 'Draft',\n    data() {\n        this.$nextTick(() => {\n            this.htmlChange();\n            this.redraw();\n        });\n        return {\n            html: extractCode() || '<Selectic\\n    :options=\"\\'list1\\'\"\\n/>',\n            selecticParams: {\n                options: 'list1',\n            },\n            selecticChild: [],\n            isHTMLValid: true,\n            selecticValue: null,\n\n            reason: '',\n            drawId: 0,\n        };\n    },\n    methods: {\n        redraw() {\n            this.drawId++;\n        },\n        onKey(evt) {\n            const key = evt.key;\n\n            if (key === 'Tab') {\n                evt.preventDefault;\n            }\n        },\n\n        highlighter(code) {\n        //    return highlight(code, languages.js); //returns html\n            return code.replace(/</g, '&lt;');\n        },\n\n        htmlChange() {\n            const html = this.html;\n\n            const [isValid, , elem] = this.parseHTML(html);\n\n            this.isHTMLValid = isValid !== false;\n\n            if (elem) {\n                const selecticParams = elem.params;\n                const selecticChild = elem.child.map((elem) => {\n                    const options = elem.child.filter((el) => el.tagName !== 'text').map((el) => {\n                        return {\n                            tagName: el.tagName,\n                            id: el.params.id || el.params.value,\n                            text: el.params.label || el.child[0]?.params?.text,\n                            options: [],\n                        };\n                    });\n                    return {\n                        tagName: elem.tagName,\n                        id: elem.params.id || elem.params.value,\n                        text: elem.params.label || elem.child[0]?.params?.text,\n                        options: options,\n                    };\n                });\n\n                this.selecticParams = selecticParams;\n                this.selecticChild = selecticChild;\n            }\n        },\n\n        parseHTML(html, name = '') {\n            let index = 0;\n            const lngth = html.length;\n            let mode = 'outside';\n            let capture = '';\n            let attribute = '';\n            let isDynamic = false;\n\n            let tagName = '';\n            const params = {};\n            const child = [];\n\n            const modes = {\n                outside: {\n                    lookFor: /[<]/,\n                    escape: /[]/,\n                    isCapturing: false,\n                },\n                inside: {\n                    lookFor: /[/>:\\w]/,\n                    escape: /[]/,\n                    isCapturing: false,\n                },\n                tagName: {\n                    lookFor: /[\\s>]/,\n                    escape: /[]/,\n                    isCapturing: true,\n                },\n                attribute: {\n                    lookFor: /[=\\s>]/,\n                    escape: /[]/,\n                    isCapturing: true,\n                },\n                attributeValue: {\n                    lookFor: /[\"]/,\n                    escape: /[\\\\]/,\n                    isCapturing: true,\n                },\n                child: {\n                    lookFor: /[^\\s]/,\n                    escape: /[]/,\n                    isCapturing: false,\n                },\n                childText: {\n                    lookFor: /[<]/,\n                    escape: /[]/,\n                    isCapturing: true,\n                },\n                end: {\n                    lookFor: /./,\n                    escape: /[]/,\n                    isCapturing: false,\n                },\n            };\n\n            mainLoop: for (index = 0; index < lngth; index++) {\n                const char = html.charAt(index);\n                const nextChar = html.charAt(index + 1);\n                const conf = modes[mode];\n\n                if (conf.lookFor.test(char)) {\n                    switch (mode) {\n                        case 'outside':\n                            mode = 'tagName';\n                            break;\n                        case 'inside':\n                            if (char === '/') {\n                                index++;\n                                mode = 'end';\n                                break mainLoop;\n                            }\n                            if (char === '>') {\n                                mode = 'child';\n                                break;\n                            }\n                            mode = 'attribute';\n                            if (char !== ':') {\n                                isDynamic = false;\n                                /* To capture the 1st letter */\n                                index--;\n                            } else {\n                                isDynamic = true;\n                            }\n                            break;\n                        case 'tagName':\n                            tagName = capture;\n                            if (tagName === '') {\n                                this.reason = 'empty tagName';\n                                return [false];\n                            }\n                            if (tagName.startsWith('/')) {\n                                const isTagName = tagName.slice(1) === name;\n                                if (!isTagName) {\n                                    this.reason = 'wrong tag ending';\n                                }\n\n                                return [isTagName, index + 1, {}, []];\n                            }\n                            if (char === '>') {\n                                mode = 'child';\n                            } else {\n                                mode = 'inside';\n                            }\n                            break;\n                        case 'attribute':\n                            attribute = capture.trim();\n                            if (char === '=') {\n                                mode = 'attributeValue';\n                                if (nextChar === ' ') {\n                                    index++;\n                                }\n                                index++;\n                            } else {\n                                params[attribute] = true;\n                                mode = 'inside';\n                            }\n                            break;\n                        case 'attributeValue':\n                            try {\n                                if (isDynamic) {\n                                    params[attribute] = JSON.parse(getJSON(capture));\n                                } else {\n                                    params[attribute] = capture;\n                                }\n                            } catch(e) {\n                                this.reason = 'attribute value is not correct';\n                                return [false];\n                            }\n                            mode = 'inside';\n                            break;\n                        case 'child':\n                            if (char === '<') {\n                                const [valid, idx, elem] = this.parseHTML(html.slice(index), tagName);\n                                if (valid === false) {\n                                    return [false];\n                                }\n                                index += idx;\n                                if (valid === true) {\n                                    mode = 'end';\n                                    break mainLoop;\n                                }\n                                child.push(elem);\n\n                                break;\n                            }\n                            mode = 'childText';\n                            index--;\n                            break;\n                        case 'childText':\n                            child.push({\n                                params:{text: capture.trim()},\n                                child: [],\n                                tagName: 'text',\n                            });\n                            mode = 'child';\n                            index--;\n                            break;\n                    }\n                    capture = '';\n                } else {\n                    if (conf && conf.isCapturing) {\n                        capture += char;\n                        if (conf.escape.test(char)) {\n                            capture += nextChar;\n                            index++;\n                        }\n                    }\n                }\n            }\n\n            if (mode !== 'end') {\n                this.reason = `tag ${tagName} is not finished`;\n                return [false];\n            }\n\n            this.reason = '';\n\n            return [null, index, {params, child, tagName}];\n        },\n    },\n    watch: {\n        html() {\n            this.htmlChange();\n        }\n    },\n    components: {\n        Selectic,\n        PrismEditor,\n    },\n}\n</script>\n<style>\n.has-error {\n    border-color: red;\n    border-width: 2px;\n    box-shadow: inset 0 0 15px red;\n}\n.error-message {\n    height: 1.2em;\n    color: #FF6666;\n}\n.half {\n    display: grid;\n    grid-template: max-content / 1fr 1fr;\n    grid-column-gap: 15px;\n}\n\n.prism-editor__textarea,\n.html-draft {\n    width: 450px;\n    height: 300px;\n    min-height: 100px;\n    min-width: 100px;\n}\n.my-editor {\n  background: #2d2d2d;\n  color: #ccc;\n\n  font-family: Fira code, Fira Mono, Consolas, Menlo, Courier, monospace;\n  font-size: 14px;\n  line-height: 1.5;\n  padding: 5px;\n}\n.prism-editor__textarea:focus {\n  outline: none;\n}\n</style>\n"]}, media: undefined });
